...
class Statistics:
    ...
    def get_cars_by_warehouse():
        ...
        for r in results:
            ...
            if warehouse:
                capacity_used = (
                    (r.quantity / warehouse.capacity * 100) if warehouse.capacity > 0 else 0
                )
    ...
    def get_price_distribution():
        ...
        for min_price, max_price, label in price_ranges:
            ...
            count = query.count()
            quantity = (
                db.session.query(func.sum(Car.quantity))
                .filter(
                    Car.price >= min_price,
    ...
    def get_trends():
        ...
        return {
            ...
            "total_inventory_value": db.session.query(func.sum(Car.price * Car.quantity)).scalar()
            or 0,
