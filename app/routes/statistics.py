...
def brand_stats(brand_id):
    ...
    stats = {
        ...
        'average_price': sum(car.price * car.quantity for car in brand.cars) / sum(car.quantity for car in brand.cars) if brand.cars else 0
    }
...
def warehouse_stats(warehouse_id):
    ...
    stats = {
        ...
        'occupancy_rate': (sum(car.quantity for car in warehouse.cars) / warehouse.capacity * 100) if warehouse.capacity > 0 else 0
    }
